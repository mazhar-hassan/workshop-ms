...
(1, 'Guardian of Donkey', 'ACTION', 'Sci-fi space Marvel movie'),
(2, 'Guardian of Galaxy II', 'ACTION', 'A Sci-fi space Marvel movie'),
(3, 'Avengers', 'ACTION', 'Funny kids movie'),
(4, 'Batman begins', 'ACTION', 'Un-realistic movie'),
(5, 'Super Man', 'ACTION', 'A Movie from Krypton');
